...
-- AddForeignKey
ALTER TABLE "prescriptions" ADD CONSTRAINT "prescriptions_paitentId_fkey" FOREIGN KEY ("paitentId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
